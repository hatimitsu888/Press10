...
summon area_effect_cloud ~ ~12000 ~ {ReapplicationDelay:-1,Radius:0f,Duration:1,Age:-1,WaitTime:0,potion_contents:{custom_effects:[{id:"minecraft:instant_damage",amplifier:0,duration:1}]},Tags:["delta.init.aec"]}
